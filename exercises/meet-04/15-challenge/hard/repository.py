...
def title_exists(title, exclude_id=None):
    # TODO 1: cek apakah SUDAH ADA expense LAIN dengan title yang sama
    # (case-insensitive), TIDAK TERMASUK expense dengan id == exclude_id
    # (supaya saat edit, title yang tidak diubah tidak dianggap
