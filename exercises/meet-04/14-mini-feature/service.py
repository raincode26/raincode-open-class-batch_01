...
from repository import (
    ...
    update_expense, delete_expense, get_total, get_category_totals
)
...
def get_totals_per_category():
    # TODO 2: Panggil get_category_totals() dari repository, lalu
    # kembalikan hasilnya. Tidak perlu logika tambahan untuk versi
    # awal — ini persis pola "Service memanggil Repository" yang
    # sudah kamu lihat di semua function lain di file ini.
